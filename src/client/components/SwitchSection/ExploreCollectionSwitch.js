...
const ExploreCollectionSwitch = ({ activity, setActivity }) => {
      ...
      <div className={s.switchWrap}>
        <ul className={s.walletSwitch}>
          <li
            key={"Nfts"}
            className={`${
              isDarkMode && activity === false
                ? "dark-explore-switch-selected"
                : ""
            } ${isDarkMode ? "dark-explore-switch" : ""}
                ${activity === false ? s.selectedButton : ""}
              `}
          >
            <div onClick={() => onItemSwitch(false)}>
          ...
          <li
            key={"Activity"}
            className={`${
              isDarkMode && activity ? "dark-explore-switch-selected" : ""
            } ${isDarkMode ? "dark-explore-switch" : ""}
                ${activity ? s.selectedButton : ""}
              `}
          >
            <div onClick={() => onItemSwitch(true)}>
...
export default ExploreCollectionSwitch;
