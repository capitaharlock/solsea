...
import { calendarSortOptions } from "../../../api/Definitions";
import s from "./CalendarFilters.scss";

const CalendarFilters = ({ tags, setQuery, query, total }) => {
  ...
  return (
    <div>
      <div
        className={`
          ${s.searchContainer} d-flex align-items-center`}
      >
        ...
        {total ? (
          ...
          <h4 className={`${s.totalCounter}`}>{t("filters.totalItems")} 0</h4>
        )}
      </div>
      <div className={`${s.filterCalendarContainer} d-flex align-items-center`}>
...
export default withStyles(s)(CalendarFilters);
