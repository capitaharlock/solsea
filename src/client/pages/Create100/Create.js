...
const Create = () => {
  ...
  const { append: appendCreators, fields: fieldsCreators, remove: removeCreators, update: updateCreators } = useFieldArray({
    control,
    name: "creators"
  });
      ...
      try {
        ...
        const metadataContent = {
          ...
          properties: {
            ...
            category: "image",
            creators: data.creators && data.creators.length > 0 ? data.creators.map((c) => new Creator({
              address: c.wallet,
              verified: walletKey.toBase58() === c.wallet,
              share: c.share
            })) : [
              new Creator({
  ...
  return (
    <div>
      ...
      <div id="container page-wrapper position-relative">
        <section
          aria-label="section"
          className={`banner profile-banner d-flex ${isDarkMode ? "dark-lighter" : "light-white"
            }`}
        >
          <h1>{t("mintNFT.mintNft")}</h1>
        </section>
        {!connected || !isLoggedIn ? (
          <div className={`container page-wrapper position-relative pt-5`}>
              ...
              <div className={`${s.section} ${s.createPage} row wow fadeIn`}>
                <div className="col-md-8">
                  <form className={` ${s.formBorder} form-border`}>
                    <div
                      className={`${s.fieldSection} ${s.required} ${isDarkMode ? "dark-red" : ""
                        } mb-4 mt-4`}
                    >
                      {/* !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! */}
                      <p style={{ color: "red" }}>
                      ...
                      <Controller
                        ...
                        render={({ field: { onChange } }) => (
                          <ImageSelector
                            className={`${s.dCreateFile} ${isDarkMode ? "dark-lighter-more" : "light-white"
                              }`}
                            name="preview"
                    ...
                    <div className={`${s.fieldSection} ${s.required} mb-4`}>
                      ...
                      <input
                        ...
                        type="text"
                        className={`form-control ${isDarkMode ? "dark-lighter-more-input" : "light-white"
                          }`}
                       ...
                       <button
                        ...
                        <input type="text"
                          className={`${isDarkMode
                              ...
                              : "light-white"
                            } form-control`} value={selectedCreator} onChange={(e) => {
                              setSelectedCreator(e.currentTarget.value)
                            }} />
                      </div>
                    </div>
                        ...
                        (item, index) => {
                          return (
                            <NftCreatorRenderer
                              ...
                              onChange={share => {
                                console.log("change called", share, index, item);
                                updateCreators(index, { ...item, share})
                              }}
                              onDelete={() => {
                                removeCreators(index)
                              }}
                            />
                          );
                        }
                    ...
                    <div className={`${s.fieldSection} mb-4`}>
                      ...
                      <div className="form-check form-switch">
                        <input
                          className={`form-check-input ${isDarkMode ? "dark-lighter-checkbox" : ""
                            }`}
                          type="checkbox"
                          id="nsfw"
                          {...register("nsfw")}
